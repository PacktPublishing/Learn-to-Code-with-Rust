In the course materials, locate and open the `saladworks` project in VSCode. Alternatively, you can create the project by executing `cargo new --lib saladworks`.
